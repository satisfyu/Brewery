...
public class BlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<BrewKettleEntity>> BREW_KETTLE_BLOCK_ENTITY = create("brew_kettle", () -> BlockEntityType.Builder.of(BrewKettleEntity::new, ObjectRegistry.WOODEN_BREWINGSTATION.get(), ObjectRegistry.COPPER_BREWINGSTATION.get(), ObjectRegistry.NETHERITE_BREWINGSTATION.get()).build(null));
