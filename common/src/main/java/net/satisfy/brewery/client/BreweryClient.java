...
import net.satisfy.brewery.entity.beer_elemental.BeerElementalModel;
import net.satisfy.brewery.entity.beer_elemental.BeerElementalRenderer;
import net.satisfy.brewery.entity.beer_elemental_barrel.BeerElementalAttackRenderer;
