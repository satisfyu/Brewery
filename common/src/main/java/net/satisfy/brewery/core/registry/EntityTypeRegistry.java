...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<EntityType<RopeKnotEntity>> ROPE_KNOT = registerEntityType("rope_knot", () -> EntityType.Builder.of(RopeKnotEntity::new, MobCategory.MISC).sized(6 / 16F, 4 / 16F).clientTrackingRange(20).canSpawnFarFromPlayer().fireImmune().eyeHeight(6 / 16F / 2).build(BreweryIdentifier.identifier("rope_knot").toString()));
    public static final RegistrySupplier<EntityType<RopeCollisionEntity>> ROPE_COLLISION = registerEntityType("rope_collision", () -> EntityType.Builder.of(RopeCollisionEntity::new, MobCategory.MISC).sized(4 / 16f, 4 / 16f).clientTrackingRange(10).noSave().noSummon().fireImmune().build(BreweryIdentifier.identifier("rope_collision").toString()));
    public static final RegistrySupplier<EntityType<HangingRopeEntity>> HANGING_ROPE = registerEntityType("hanging_rope", () -> EntityType.Builder.of(HangingRopeEntity::new, MobCategory.MISC).sized(4 / 16f, 4 / 16f).clientTrackingRange(10).noSave().noSummon().fireImmune().eyeHeight(6 / 16F / 2).build(BreweryIdentifier.identifier("hanging_rope").toString()));
