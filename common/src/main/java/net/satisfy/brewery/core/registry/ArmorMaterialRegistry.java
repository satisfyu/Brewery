...
public class ArmorMaterialRegistry {
    ...
    public static final Holder<ArmorMaterial> BREWFEST = register("leather", Util.make(new EnumMap(ArmorItem.Type.class), (enumMap) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> Ingredient.of(Items.LEATHER), List.of(new ArmorMaterial.Layer(ResourceLocation.withDefaultNamespace("brewfest"), "", true), new ArmorMaterial.Layer(ResourceLocation.withDefaultNamespace("leather"), "_overlay", false)));
